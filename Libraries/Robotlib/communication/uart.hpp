...
public:
  ...
  uint8_t receiving_data_dma[MAX_RX_PACKET_SIZE-3]; /*Removing start, len and crc.*/

  uint8_t transmission_data[MAX_TX_PACKET_SIZE]; /** Array to transmit start byte, data, hasg and line-feed (\n). */
